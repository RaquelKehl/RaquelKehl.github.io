...
| No tracking — aggregate, identity-free page counts only; no cookies, `no-referrer` everywhere | Visits leave a per-day page total and nothing else — no IPs, no identifiers, GPC/DNT respected; outbound clicks never tell third parties where you came from |
